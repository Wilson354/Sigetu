          ...
          <Row>
            ...
            <Card className="shadow">
                <CardHeader className="border-0">
                  <h3 className="mb-0">Evaluaciones Estadias</h3>
                  <div className="nav-wrapper">
                    ...
                    >
                      <NavItem>
                        <NavLink
                          aria-selected={this.state.tabsin === 1}
                          className={classnames("mb-sm-3 mb-md-0", {
                            active: this.state.tabsin === 1
                          })}
                          onClick={e => this.toggleNavs(e, "tabsin", 1)}
                          href="#wilson"
                          role="tab"
                        >
                          Quinto
                      ...
                      <NavItem>
                        <NavLink
                          aria-selected={this.state.tabsin === 2}
                          className={classnames("mb-sm-3 mb-md-0", {
                            active: this.state.tabsin === 2
                          })}
                          onClick={e => this.toggleNavs(e, "tabsin", 2)}
                          href="#pablo"
                          role="tab"
                        >
                          Decimo
